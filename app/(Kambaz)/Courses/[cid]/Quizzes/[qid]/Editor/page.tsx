...
export default function QuizEditor() {
  ...
  const { questions } = useSelector((state: { questionReducer: { questions: unknown[] } }) => state.questionReducer);

  const isNewQuiz = !qid || qid === "Editor";

  const [quiz, setQuiz] = useState({
    _id: qid && qid !== "Editor" ? qid : "",
    title: "",
    course: cid ?? "",
    instruction: "",
    available: "",
        ...
        <div>
          {isNewQuiz ? (
            <>
              ...
              <Button variant="primary" onClick={addQuestion} disabled>Add Question</Button>
            </>
          ) : (
